...
library set /LIBS/nangate-45nm_beh/MODS/mgc_mux1hot/PARAMETERS/ctrlw -- -CHAR_RANGE {2 to 2, 4 to 32, 44}
...
library set /LIBS/nangate-45nm_beh/MODS/mgc_or/PARAMETERS/ninps -- -CHAR_RANGE {2 to 2, 4 to 32, 40}
