...
typedef
    ccs_design::HDL::test_orig_wrapper ccs_DUT_wrapper;
...
public:
  ...
  sc_in<bool> clk;
  sc_in<sc_logic> rst;
  sc_in<sc_lv<1280> > din_in_rsc_dat;
  sc_out<sc_logic> din_in_rsc_triosy_lz;
  sc_in<sc_lv<6> > offset_rsc_dat;
  sc_out<sc_logic> offset_rsc_triosy_lz;
  sc_out<sc_lv<1280> > dout_rsc_dat;
  sc_out<sc_logic> dout_rsc_triosy_lz;
public:
  ccs_DUT_wrapper(const sc_module_name& nm, const char *hdl_name)
  :
