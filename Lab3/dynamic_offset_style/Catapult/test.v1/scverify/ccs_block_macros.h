...
extern void mc_testbench_capture_IN( int din[40], ac_int<6, false > offset,  int dout[40]);
extern void mc_testbench_capture_OUT( int din[40], ac_int<6, false > offset,  int dout[40]);
extern void mc_testbench_wait_for_idle_sync();

#define ccs_intercept_test_3 \
  ccs_real_test(int din[40],ac_int<6, false > offset,int dout[40]);\
  void test(int din[40],ac_int<6, false > offset,int dout[40])\
{\
    ...
    mc_testbench_capture_IN(din,offset,dout);\
    ccs_real_test(din,offset,dout);\
    mc_testbench_capture_OUT(din,offset,dout);\
}\
  void ccs_real_test
#else
#define ccs_intercept_test_3 test
...
// test_wrapper 26 BLOCK
#define ccs_intercept_test_wrapper_26 test_wrapper
