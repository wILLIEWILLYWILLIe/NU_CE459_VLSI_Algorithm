...
public:
  ...
  sc_signal<sc_lv<1280> >                                     TLS_din_rsc_dat;
  sc_signal<sc_logic>                                         TLS_din_rsc_triosy_lz;
  ...
  ccs_in_trans_rsc_v1<1,1280 >                                din_rsc_INST;
  ccs_in_trans_rsc_v1<1,6 >                                   offset_rsc_INST;
  ccs_out_trans_rsc_v1<1,1280 >                               dout_rsc_INST;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<int,40> >                TLS_in_fifo_din;
  tlm::tlm_fifo<mc_wait_ctrl>                                 TLS_in_wait_ctrl_fifo_din;
  mc_trios_input_monitor                                      trios_monitor_din_rsc_triosy_lz_INST;
  mc_input_transactor<mgc_sysc_ver_array1D<int,40>,32,true>   transactor_din;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_din_rsc_triosy_lz("TLS_din_rsc_triosy_lz")
    ...
    , trios_monitor_din_rsc_triosy_lz_INST("trios_monitor_din_rsc_triosy_lz_INST")
    , transactor_din("transactor_din", 0, 1280, 0)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    test_INST.din_rsc_dat(TLS_din_rsc_dat);
    test_INST.din_rsc_triosy_lz(TLS_din_rsc_triosy_lz);
    test_INST.offset_rsc_dat(TLS_offset_rsc_dat);
    test_INST.offset_rsc_triosy_lz(TLS_offset_rsc_triosy_lz);
    test_INST.dout_rsc_dat(TLS_dout_rsc_dat);
    test_INST.dout_rsc_triosy_lz(TLS_dout_rsc_triosy_lz);

    din_rsc_INST.dat(TLS_din_rsc_dat);
    din_rsc_INST.clk(clk);
    din_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_1)));
    ...
    trios_monitor_din_rsc_triosy_lz_INST.trios(TLS_din_rsc_triosy_lz);
    trios_monitor_din_rsc_triosy_lz_INST.register_mon(&catapult_monitor_INST);
    ...
    transactor_din.register_block(&din_rsc_INST, din_rsc_INST.basename(), TLS_din_rsc_triosy_lz, 0, 0, 1);
...
void scverify_top::start_of_simulation() {
  ...
  if (SCVerify_AUTOWAIT) {
    ...
    transactor_din.set_auto_wait_limit(l);
...
#else
  static int transactor_din_flags = MC_TRANSACTOR_UNDERFLOW | MC_TRANSACTOR_WAIT;
