...
//  Generated date: Thu Nov  6 11:08:43 2025
// ----------------------------------------------------------------------
...
module test_orig_core_core_fsm (
  clk, rst, core_wen, fsm_output, MAC_C_1_tr0
);
  input clk;
  input rst;
  input core_wen;
...
module test_orig_core (
  ...
  wire [4:0] fsm_output;
  wire MAC_if_mux_tmp;
  reg [4:0] MAC_i_4_0_sva_1;
  wire [5:0] nl_MAC_i_4_0_sva_1;
  reg MAC_slc_valid_data_1_0_svs_st;
  ...
  reg [15:0] MAC_if_mul_itm;
  reg [3:0] MAC_i_4_0_sva_3_0;
  wire [19:0] acc_sva_dfm_mx0w0;
  wire [20:0] nl_acc_sva_dfm_mx0w0;
  wire result_rsci_idat_mx0c1;
  wire a_data_and_cse;

  wire[0:0] acc_not_1_nl;
  wire[7:0] MAC_if_mux_1_nl;
  wire[7:0] MAC_if_mux_2_nl;

  // Interconnect Declarations for Component Instantiations 
  wire [0:0] nl_test_orig_core_core_fsm_inst_MAC_C_1_tr0;
  assign nl_test_orig_core_core_fsm_inst_MAC_C_1_tr0 = MAC_i_4_0_sva_1[4];
  ...
  test_orig_core_core_fsm test_orig_core_core_fsm_inst (
      ...
      .MAC_C_1_tr0(nl_test_orig_core_core_fsm_inst_MAC_C_1_tr0[0:0])
    );
  assign a_data_and_cse = core_wen & (fsm_output[3:2]==2'b00);
  assign nl_acc_sva_dfm_mx0w0 = acc_sva + conv_s2s_16_20(MAC_if_mul_itm);
  assign acc_sva_dfm_mx0w0 = nl_acc_sva_dfm_mx0w0[19:0];
  ...
  assign result_rsci_idat_mx0c1 = (MAC_i_4_0_sva_1[4]) & (~ MAC_slc_valid_data_1_0_svs_st)
      & (fsm_output[3]);
  always @(posedge clk) begin
    if ( rst ) begin
      ...
      MAC_i_4_0_sva_1 <= 5'b00000;
      MAC_slc_valid_data_1_0_svs_st <= 1'b0;
    end
    else if ( core_wen ) begin
      reg_valid_in_data_rsc_triosy_obj_ld_core_psct_cse <= (MAC_i_4_0_sva_1[4]) &
          (fsm_output[3]);
      reg_b_in_rsci_irdy_core_psct_cse <= (fsm_output[0]) | (fsm_output[4]);
      MAC_i_4_0_sva_3_0 <= MUX_v_4_2_2(4'b0000, (MAC_i_4_0_sva_1[3:0]), (fsm_output[3]));
      MAC_i_4_0_sva_1 <= nl_MAC_i_4_0_sva_1[4:0];
  ...
  always @(posedge clk) begin
    ...
    else if ( core_wen & (((MAC_i_4_0_sva_1[4]) & MAC_slc_valid_data_1_0_svs_st &
        (fsm_output[3])) | result_rsci_idat_mx0c1) ) begin
  ...
  always @(posedge clk) begin
    ...
    else if ( (((fsm_output[3]) & MAC_slc_valid_data_1_0_svs_st) | (fsm_output[1]))
        & core_wen ) begin
      acc_sva <= MUX_v_20_2_2(20'b00000000000000000000, acc_sva_dfm_mx0w0, (acc_not_1_nl));
    end
  end
  always @(posedge clk) begin
    if ( rst ) begin
      MAC_if_mul_itm <= 16'b0000000000000000;
    end
    else if ( core_wen & MAC_if_mux_tmp ) begin
      MAC_if_mul_itm <= conv_s2u_16_16($signed((MAC_if_mux_1_nl)) * $signed((MAC_if_mux_2_nl)));
    end
  end
  assign nl_MAC_i_4_0_sva_1  = conv_u2s_4_5(MAC_i_4_0_sva_3_0) + 5'b00001;
  assign acc_not_1_nl = ~ (fsm_output[1]);
