ifeq "$(CXX_HOME)" ""
CXX_HOME                                            := /vol/mentor/Catapult_Synthesis_10.4a/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                            := gcc
...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                      := /vol/mentor/questa_sim-2019.3_2/questasim/bin
...
OSCI_SYSTEMC_INCLUDE                                := /vol/mentor/Catapult_Synthesis_10.4a/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                                    := /vol/mentor/Catapult_Synthesis_10.4a/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                          := /vol/mentor/questa_sim-2019.3_2/questasim/bin
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                           := 
