...
typedef
    ccs_design::HDL::test_orig ccs_DUT_wrapper;
...
public:
  ...
  sc_in<bool> clk;
  sc_in<sc_logic> rst;
  sc_in<sc_lv<128> > a_in_rsc_dat;
  sc_in<sc_logic> a_in_rsc_vld;
  sc_out<sc_logic> a_in_rsc_rdy;
  sc_in<sc_lv<128> > b_in_rsc_dat;
  sc_in<sc_logic> b_in_rsc_vld;
  sc_out<sc_logic> b_in_rsc_rdy;
  sc_in<sc_lv<16> > valid_in_data_rsc_dat;
  sc_out<sc_logic> valid_in_data_rsc_triosy_lz;
  sc_out<sc_lv<20> > result_rsc_dat;
