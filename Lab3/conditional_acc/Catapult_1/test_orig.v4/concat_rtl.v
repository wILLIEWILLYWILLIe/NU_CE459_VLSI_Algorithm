...
//  Generated date: Thu Nov  6 11:23:07 2025
// ----------------------------------------------------------------------
...
module test_orig_core (
  ...
  wire MAC_if_mux_3_tmp;
  wire MAC_if_mux_tmp;
  reg MAC_2_slc_valid_data_1_0_svs_1;
  reg main_stage_0_2;
  reg exitL_exit_MAC_sva;
  reg MAC_1_slc_valid_data_1_0_svs_1;
  ...
  wire [19:0] acc_sva_4;
  wire [20:0] nl_acc_sva_4;
  wire [19:0] acc_lpi_1_dfm_1_mx0;
  wire [2:0] MAC_i_3_1_lpi_1_dfm_1;
  reg [2:0] MAC_slc_MAC_2_acc_1_4_1_psp_sva_2_0;
  wire and_12_cse;

  wire[0:0] and_2_nl;
  wire[19:0] MAC_mux_1_nl;
  wire[0:0] MAC_not_7_nl;
  wire[7:0] MAC_if_mux_1_nl;
  wire[7:0] MAC_if_mux_2_nl;
  wire[7:0] MAC_if_mux_4_nl;
  wire[7:0] MAC_if_mux_5_nl;
  wire[19:0] MAC_1_if_acc_nl;
  wire[20:0] nl_MAC_1_if_acc_nl;
  ...
  assign and_12_cse = (~ (MAC_slc_MAC_2_MAC_acc_tmp[3])) & core_wen & exitL_exit_MAC_sva;
  assign MAC_if_mux_3_tmp = MUX_s_1_8_2((valid_data_lpi_1_dfm_mx0[1]), (valid_data_lpi_1_dfm_mx0[3]),
  ...
  assign MAC_if_mux_tmp = MUX_s_1_8_2((valid_data_lpi_1_dfm_mx0[0]), (valid_data_lpi_1_dfm_mx0[2]),
  ...
  assign valid_data_lpi_1_dfm_mx0 = MUX_v_16_2_2(valid_data_lpi_1_dfm, valid_in_data_rsci_idat,
      exitL_exit_MAC_sva);
  assign nl_MAC_slc_MAC_2_MAC_acc_tmp = conv_u2s_3_4(MAC_i_3_1_lpi_1_dfm_1) + 4'b0001;
  ...
  assign a_data_lpi_1_dfm_mx0 = MUX_v_128_2_2(a_data_lpi_1_dfm, a_in_rsci_idat_mxwt,
      exitL_exit_MAC_sva);
  assign nl_acc_sva_4 = acc_lpi_1_dfm_1_mx0 + conv_s2s_16_20(MAC_2_if_mul_itm_1);
  assign acc_sva_4 = nl_acc_sva_4[19:0];
  assign nl_MAC_1_if_acc_nl = acc_lpi_1_dfm_1 + conv_s2s_16_20(MAC_1_if_mul_itm_1);
  assign MAC_1_if_acc_nl = nl_MAC_1_if_acc_nl[19:0];
  assign acc_lpi_1_dfm_1_mx0 = MUX_v_20_2_2(acc_lpi_1_dfm_1, (MAC_1_if_acc_nl), MAC_1_slc_valid_data_1_0_svs_1);
  assign MAC_not_9_nl = ~ exitL_exit_MAC_sva;
  assign MAC_i_3_1_lpi_1_dfm_1 = MUX_v_3_2_2(3'b000, MAC_slc_MAC_2_acc_1_4_1_psp_sva_2_0,
      (MAC_not_9_nl));
  always @(posedge clk) begin
    if ( rst ) begin
      ...
      MAC_2_slc_valid_data_1_0_svs_1 <= 1'b0;
      MAC_1_slc_valid_data_1_0_svs_1 <= 1'b0;
      MAC_slc_MAC_2_acc_1_4_1_psp_sva_2_0 <= 3'b000;
      main_stage_0_2 <= 1'b0;
    end
    else if ( core_wen ) begin
      reg_b_in_rsci_oswt_cse <= ~((~ (MAC_slc_MAC_2_MAC_acc_tmp[3])) & (fsm_output[1]));
      ...
      MAC_slc_MAC_2_acc_1_4_1_psp_sva_2_0 <= MAC_slc_MAC_2_MAC_acc_tmp[2:0];
  ...
  always @(posedge clk) begin
    ...
    else if ( (MAC_1_slc_valid_data_1_0_svs_1 | MAC_2_slc_valid_data_1_0_svs_1 |
        exitL_exit_MAC_sva) & core_wen ) begin
      acc_lpi_1_dfm_1 <= MUX_v_20_2_2(20'b00000000000000000000, (MAC_mux_1_nl), (MAC_not_7_nl));
    end
  end
  always @(posedge clk) begin
    if ( rst ) begin
      MAC_1_if_mul_itm_1 <= 16'b0000000000000000;
    end
    else if ( core_wen & MAC_if_mux_tmp ) begin
      MAC_1_if_mul_itm_1 <= conv_s2u_16_16($signed((MAC_if_mux_1_nl)) * $signed((MAC_if_mux_2_nl)));
    end
  end
  always @(posedge clk) begin
    if ( rst ) begin
    ...
    else if ( core_wen & MAC_if_mux_3_tmp ) begin
      MAC_2_if_mul_itm_1 <= conv_s2u_16_16($signed((MAC_if_mux_4_nl)) * $signed((MAC_if_mux_5_nl)));
    end
  end
  always @(posedge clk) begin
    if ( rst ) begin
  ...
  assign and_2_nl = result_and_1_cse & (~ MAC_2_slc_valid_data_1_0_svs_1);
  assign MAC_mux_1_nl = MUX_v_20_2_2(acc_lpi_1_dfm_1_mx0, acc_sva_4, MAC_2_slc_valid_data_1_0_svs_1);
  assign MAC_not_7_nl = ~ exitL_exit_MAC_sva;
  assign MAC_if_mux_1_nl = MUX_v_8_8_2((a_data_lpi_1_dfm_mx0[7:0]), (a_data_lpi_1_dfm_mx0[23:16]),
      (a_data_lpi_1_dfm_mx0[39:32]), (a_data_lpi_1_dfm_mx0[55:48]), (a_data_lpi_1_dfm_mx0[71:64]),
      (a_data_lpi_1_dfm_mx0[87:80]), (a_data_lpi_1_dfm_mx0[103:96]), (a_data_lpi_1_dfm_mx0[119:112]),
      MAC_i_3_1_lpi_1_dfm_1);
  assign MAC_if_mux_2_nl = MUX_v_8_8_2((b_data_lpi_1_dfm_mx0[7:0]), (b_data_lpi_1_dfm_mx0[23:16]),
      (b_data_lpi_1_dfm_mx0[39:32]), (b_data_lpi_1_dfm_mx0[55:48]), (b_data_lpi_1_dfm_mx0[71:64]),
      (b_data_lpi_1_dfm_mx0[87:80]), (b_data_lpi_1_dfm_mx0[103:96]), (b_data_lpi_1_dfm_mx0[119:112]),
      MAC_i_3_1_lpi_1_dfm_1);
  assign MAC_if_mux_4_nl = MUX_v_8_8_2((a_data_lpi_1_dfm_mx0[15:8]), (a_data_lpi_1_dfm_mx0[31:24]),
      (a_data_lpi_1_dfm_mx0[47:40]), (a_data_lpi_1_dfm_mx0[63:56]), (a_data_lpi_1_dfm_mx0[79:72]),
      (a_data_lpi_1_dfm_mx0[95:88]), (a_data_lpi_1_dfm_mx0[111:104]), (a_data_lpi_1_dfm_mx0[127:120]),
      MAC_i_3_1_lpi_1_dfm_1);
  assign MAC_if_mux_5_nl = MUX_v_8_8_2((b_data_lpi_1_dfm_mx0[15:8]), (b_data_lpi_1_dfm_mx0[31:24]),
      (b_data_lpi_1_dfm_mx0[47:40]), (b_data_lpi_1_dfm_mx0[63:56]), (b_data_lpi_1_dfm_mx0[79:72]),
      (b_data_lpi_1_dfm_mx0[95:88]), (b_data_lpi_1_dfm_mx0[111:104]), (b_data_lpi_1_dfm_mx0[127:120]),
      MAC_i_3_1_lpi_1_dfm_1);
