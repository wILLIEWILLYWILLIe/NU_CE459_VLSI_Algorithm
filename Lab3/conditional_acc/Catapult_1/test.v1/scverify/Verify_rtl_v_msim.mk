...
# Generated date: Thu Nov 06 11:26:04 CST 2025
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   SOLUTION_DIR  /home/gel8580/CE459/Lab3/conditional_acc/Catapult_1/test.v1
#   WORKING_DIR   /home/gel8580/CE459/Lab3/conditional_acc/Catapult_1/test.v1/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./Catapult_1/test.v1
PROJ2SOLN = ./Catapult_1/test.v1
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /home/gel8580/CE459/Lab3/conditional_acc/Catapult_1/test.v1/rtl.v
endif
...
TOP_DU                   := scverify_top
CXX_TYPE                 := gcc
MSIM_SCRIPT              := ./Catapult_1/test.v1/scverify_msim.tcl
...
CXXFLAGS += -DCCS_SCVERIFY -DSC_INCLUDE_DYNAMIC_PROCESSES -DSC_USE_STD_STRING -DTOP_HDL_ENTITY=$(TOP_HDL_ENTITY) -DCCS_DESIGN_FUNC_test -DCCS_DESIGN_TOP_$(TOP_HDL_ENTITY) -DCCS_MISMATCHED_OUTPUTS_ONLY $(F_WRAP_OPT)
# 
