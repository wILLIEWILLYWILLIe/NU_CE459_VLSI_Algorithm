...
#define ccs_intercept_test_5 \
  ccs_real_test(ac_channel<pack<ac_int<8, true > > > &a_in,ac_channel<pack<ac_int<8, true > > > &b_in,pack<bool > valid_in,ac_channel<ac_int<20, true > > &result);\
  void test(ac_channel<pack<ac_int<8, true > > > &a_in,ac_channel<pack<ac_int<8, true > > > &b_in,pack<bool > valid_in,ac_channel<ac_int<20, true > > &result)\
{\
    ...
    ccs_real_test(a_in,b_in,valid_in,result);\
    mc_testbench_capture_OUT(a_in,b_in,valid_in,result);\
}\
  void ccs_real_test
#else
#define ccs_intercept_test_5 test
