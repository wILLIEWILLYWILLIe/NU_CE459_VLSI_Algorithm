...
public:
   // Interface Ports
   sc_in< bool > clk;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_fixed<16, 8, true, AC_TRN, AC_WRAP >,9> > > ccs_input;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_input;
   sc_port< tlm::tlm_fifo_get_if< ac_fixed<16, 8, true, AC_TRN, AC_WRAP > > > ccs_output;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_output;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_fixed<16, 8, true, AC_TRN, AC_WRAP >,9> > > ccs_filter;
   ...
   tlm::tlm_fifo< mc_golden_info< ac_fixed<16, 8, true, AC_TRN, AC_WRAP >, ac_fixed<16, 8, true, AC_TRN, AC_WRAP > > > output_golden;
   ...
   mc_comparator< ac_fixed<16, 8, true, AC_TRN, AC_WRAP > , ac_fixed<16, 8, true, AC_TRN, AC_WRAP > > *output_comp;
      ...
      , output_golden("output_golden",-1)
   {
      ...
      output_comp = new mc_comparator< ac_fixed<16, 8, true, AC_TRN, AC_WRAP > , ac_fixed<16, 8, true, AC_TRN, AC_WRAP > > (
         "output_comp",
         "output",
         0,
         0,
   ...
   public:
      void reset_request() ;
   public:
      void capture_input( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9]) ;
   public:
      void capture_output( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output) ;
   public:
      void capture_filter( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9]) ;
   protected:
      void wait_on_input_required() ;
   public:
      static void capture_IN( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9],  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output,  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9]) ;
   public:
      static void capture_OUT( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9],  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output,  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9]) ;
   public:
