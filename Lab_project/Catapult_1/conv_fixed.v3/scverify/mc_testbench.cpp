...
// Generated date: Mon Dec 01 01:44:57 CST 2025
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
ac_fixed<16, 8, true, AC_TRN, AC_WRAP > testbench::output_output_mask;
...
extern "C++" void conv_fixed( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9],  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output,  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9]);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_conv_fixed( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9],  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output,  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9]) {
   return mc_testbench::exec_conv_fixed(input, output, filter);
}
#endif
...
void mc_testbench::capture_input( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9])
{
   ...
   if (_capture_input && !testbench::input_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_fixed<16, 8, true, AC_TRN, AC_WRAP >,9> input_tmp;
...
void mc_testbench::capture_output( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output)
{
   if (_capture_output)
   {
      int cur_iter = output_iteration_count;
      ++output_iteration_count;
      mc_golden_info< ac_fixed<16, 8, true, AC_TRN, AC_WRAP >, ac_fixed<16, 8, true, AC_TRN, AC_WRAP > > output_tmp((*output), testbench::output_ignore, ~0, false, output_iteration_count);
...
void mc_testbench::capture_filter( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9])
{
   ...
   if (_capture_filter && !testbench::filter_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_fixed<16, 8, true, AC_TRN, AC_WRAP >,9> filter_tmp;
...
void mc_testbench::capture_IN( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9],  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output,  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9])
{
...
void mc_testbench::capture_OUT( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9],  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output,  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9])
{
   that->capture_output(output);
}
// ============================================
// Function: exec_conv_fixed
// --------------------------------------------

void mc_testbench::exec_conv_fixed( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9],  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output,  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
   capture_IN(input, output, filter);
   conv_fixed(input, output, filter);
