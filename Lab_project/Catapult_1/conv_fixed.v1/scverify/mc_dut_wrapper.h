...
typedef
    ccs_design::HDL::conv_fixed ccs_DUT_wrapper;
...
public:
  ...
  sc_in<bool> clk;
  sc_in<sc_logic> rst;
  sc_in<sc_lv<144> > input_rsc_dat;
  sc_out<sc_logic> input_rsc_triosy_lz;
  sc_out<sc_lv<16> > output_rsc_dat;
  sc_out<sc_logic> output_rsc_triosy_lz;
  sc_in<sc_lv<144> > filter_rsc_dat;
  sc_out<sc_logic> filter_rsc_triosy_lz;
public:
  ccs_DUT_wrapper(const sc_module_name& nm, const char *hdl_name)
  :
