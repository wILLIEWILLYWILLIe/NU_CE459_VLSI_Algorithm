...
#ifdef  CCS_DESIGN_FUNC_conv_fixed
extern void mc_testbench_capture_IN( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9],  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output,  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9]);
extern void mc_testbench_capture_OUT( ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9],  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output,  ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9]);
extern void mc_testbench_wait_for_idle_sync();

#define ccs_intercept_conv_fixed_3 \
  ccs_real_conv_fixed(ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9],ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output,ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9]);\
  void conv_fixed(ac_fixed<16, 8, true, AC_TRN, AC_WRAP > input[9],ac_fixed<16, 8, true, AC_TRN, AC_WRAP > *output,ac_fixed<16, 8, true, AC_TRN, AC_WRAP > filter[9])\
{\
    static bool ccs_intercept_flag = false;\
    if (!ccs_intercept_flag) {\
      std::cout << "SCVerify intercepting C++ function 'conv_fixed' for RTL block 'conv_fixed'" << std::endl;\
      ccs_intercept_flag=true;\
    }\
    mc_testbench_capture_IN(input,output,filter);\
    ccs_real_conv_fixed(input,output,filter);\
    mc_testbench_capture_OUT(input,output,filter);\
}\
  void ccs_real_conv_fixed
#else
#define ccs_intercept_conv_fixed_3 conv_fixed
#endif //CCS_DESIGN_FUNC_conv_fixed
...
// iv 1358 INLINE
#define ccs_intercept_iv_1358 iv
// const 1500 INLINE
...
// const 1430 INLINE
#define ccs_intercept_const_1430 const
// const 1426 INLINE
#define ccs_intercept_const_1426 const
// const 1380 INLINE
...
// iv_const_shift_r 1122 INLINE
#define ccs_intercept_iv_const_shift_r_1122 iv_const_shift_r
// iv_equal_zeros_to 328 INLINE
#define ccs_intercept_iv_equal_zeros_to_328 iv_equal_zeros_to
// iv_equal_zero 240 INLINE
#define ccs_intercept_iv_equal_zero_240 iv_equal_zero
// iv_uadd_carry 500 INLINE
#define ccs_intercept_iv_uadd_carry_500 iv_uadd_carry
// iv_const_shift_l 1084 INLINE
#define ccs_intercept_iv_const_shift_l_1084 iv_const_shift_l
// iv_equal_ones_from 289 INLINE
#define ccs_intercept_iv_equal_ones_from_289 iv_equal_ones_from
// iv_equal_zeros_from 302 INLINE
#define ccs_intercept_iv_equal_zeros_from_302 iv_equal_zeros_from
// iv_conv_from_fraction 1153 INLINE
#define ccs_intercept_iv_conv_from_fraction_1153 iv_conv_from_fraction
// iv_equal_ones 255 INLINE
#define ccs_intercept_iv_equal_ones_255 iv_equal_ones
// value 2969 INLINE
...
// frexp_d 1383 INLINE
#define ccs_intercept_frexp_d_1383 frexp_d
// frexp_f 1401 INLINE
#define ccs_intercept_frexp_f_1401 frexp_f
// frexp_sm_d 1420 INLINE
#define ccs_intercept_frexp_sm_d_1420 frexp_sm_d
// frexp_sm_f 1441 INLINE
#define ccs_intercept_frexp_sm_f_1441 frexp_sm_f
