...
public:
  ...
  tlm::tlm_fifo<mgc_sysc_ver_array1D<signed short,9> >               TLS_in_fifo_input;
  tlm::tlm_fifo<mc_wait_ctrl>                                        TLS_in_wait_ctrl_fifo_input;
  mc_trios_input_monitor                                             trios_monitor_input_rsc_triosy_lz_INST;
  mc_input_transactor<mgc_sysc_ver_array1D<signed short,9>,16,true>  transactor_input;
  tlm::tlm_fifo<signed short >                                       TLS_out_fifo_output;
  tlm::tlm_fifo<mc_wait_ctrl>                                        TLS_out_wait_ctrl_fifo_output;
  mc_trios_output_monitor                                            trios_monitor_output_rsc_triosy_lz_INST;
  mc_output_transactor<signed short,16,true>                         transactor_output;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<signed short,9> >               TLS_in_fifo_filter;
  tlm::tlm_fifo<mc_wait_ctrl>                                        TLS_in_wait_ctrl_fifo_filter;
  mc_trios_input_monitor                                             trios_monitor_filter_rsc_triosy_lz_INST;
  mc_input_transactor<mgc_sysc_ver_array1D<signed short,9>,16,true>  transactor_filter;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 15, 15, 0)
    , catapult_monitor_INST("Monitor", clk, true, 15LL, 15LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    conv_INST.input_rsc_dat(TLS_input_rsc_dat);
    conv_INST.input_rsc_triosy_lz(TLS_input_rsc_triosy_lz);
    conv_INST.output_rsc_dat(TLS_output_rsc_dat);
    conv_INST.output_rsc_triosy_lz(TLS_output_rsc_triosy_lz);
    conv_INST.filter_rsc_dat(TLS_filter_rsc_dat);
    conv_INST.filter_rsc_triosy_lz(TLS_filter_rsc_triosy_lz);
