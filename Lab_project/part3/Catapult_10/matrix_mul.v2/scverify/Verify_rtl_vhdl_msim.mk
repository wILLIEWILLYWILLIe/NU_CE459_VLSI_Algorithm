...
#   PROJECT_HOME  /home/gel8580/CE459/Lab_project/part3
#   SOLUTION_DIR  /home/gel8580/CE459/Lab_project/part3/Catapult_10/matrix_mul.v2
#   WORKING_DIR   /home/gel8580/CE459/Lab_project/part3/Catapult_10/matrix_mul.v2/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./Catapult_10/matrix_mul.v2
PROJ2SOLN = ./Catapult_10/matrix_mul.v2
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /home/gel8580/CE459/Lab_project/part3/Catapult_10/matrix_mul.v2/rtl.vhdl
endif
...
export SCVLIBS
export MODELSIM
TOP_HDL_ENTITY           := matrix_mul
TOP_DU                   := scverify_top
CXX_TYPE                 := gcc
MSIM_SCRIPT              := ./Catapult_10/matrix_mul.v2/scverify_msim.tcl
...
VHDL_SRC += $(MGC_HOME)/pkgs/siflibs/ccs_in_v1.vhd/ccs_in_v1.vhd.vhdlts $(MGC_HOME)/pkgs/siflibs/mgc_io_sync_v2.vhd/mgc_io_sync_v2.vhd.vhdlts $(GATE_VHDL_DEP)
VLOG_SRC +=  $(GATE_VLOG_DEP)
else
VHDL_SRC += $(MGC_HOME)/pkgs/siflibs/ccs_in_v1.vhd/ccs_in_v1.vhd.vhdlts $(MGC_HOME)/pkgs/siflibs/mgc_io_sync_v2.vhd/mgc_io_sync_v2.vhd.vhdlts ./rtl.vhdl/rtl.vhdl.vhdlts
VLOG_SRC += 
endif
CXX_SRC  = ../../matmul.cpp/matmul.cpp.cxxts ./scverify/mc_testbench.cpp/mc_testbench.cpp.cxxts ./scverify/scverify_top.cpp/scverify_top.cpp.cxxts
...
CXXFLAGS += -DCCS_SCVERIFY -DSC_INCLUDE_DYNAMIC_PROCESSES -DSC_USE_STD_STRING -DTOP_HDL_ENTITY=$(TOP_HDL_ENTITY) -DCCS_DESIGN_FUNC_matrix_mul -DCCS_DESIGN_TOP_$(TOP_HDL_ENTITY) -DCCS_MISMATCHED_OUTPUTS_ONLY $(F_WRAP_OPT)
# 
...
$(TARGET)/matmul.cpp.cxxts: ../../matmul.cpp
...
$(TARGET)/matmul.cpp.cxxts: CXX_OPTS=
# 
# Specify dependencies
$(TARGET)/matmul.cpp.cxxts: .ccs_env_opts/SCVerify_USE_CCS_BLOCK.ts
...
$(TARGET)/rtl.vhdl.vhdlts: DUT_E=matrix_mul
