...
public:
  ...
  sc_signal<sc_lv<10> >                                                                                   TLS_A_rsc_adr;
  sc_signal<sc_lv<32> >                                                                                   TLS_A_rsc_d;
  sc_signal<sc_logic>                                                                                     TLS_A_rsc_we;
  sc_signal<sc_lv<32> >                                                                                   TLS_A_rsc_q;
  sc_signal<sc_logic>                                                                                     TLS_A_rsc_triosy_lz;
  sc_signal<sc_lv<10> >                                                                                   TLS_B_rsc_adr;
  sc_signal<sc_lv<32> >                                                                                   TLS_B_rsc_d;
  sc_signal<sc_logic>                                                                                     TLS_B_rsc_we;
  sc_signal<sc_lv<32> >                                                                                   TLS_B_rsc_q;
  ...
  ccs_ram_sync_singleport_trans_rsc<32,10,1024 >                                                          A_rsc_INST;
  ccs_ram_sync_singleport_trans_rsc<32,10,1024 >                                                          B_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_rst("TLS_rst")
    , TLS_A_rsc_adr("TLS_A_rsc_adr")
    , TLS_A_rsc_d("TLS_A_rsc_d")
    , TLS_A_rsc_we("TLS_A_rsc_we")
    , TLS_A_rsc_q("TLS_A_rsc_q")
    , TLS_A_rsc_triosy_lz("TLS_A_rsc_triosy_lz")
    , TLS_B_rsc_adr("TLS_B_rsc_adr")
    , TLS_B_rsc_d("TLS_B_rsc_d")
    , TLS_B_rsc_we("TLS_B_rsc_we")
    , TLS_B_rsc_q("TLS_B_rsc_q")
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 100386, 100386, 0)
    , catapult_monitor_INST("Monitor", clk, true, 100386LL, 100386LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    matrix_mul_INST.A_rsc_adr(TLS_A_rsc_adr);
    matrix_mul_INST.A_rsc_d(TLS_A_rsc_d);
    matrix_mul_INST.A_rsc_we(TLS_A_rsc_we);
    matrix_mul_INST.A_rsc_q(TLS_A_rsc_q);
    matrix_mul_INST.A_rsc_triosy_lz(TLS_A_rsc_triosy_lz);
    matrix_mul_INST.B_rsc_adr(TLS_B_rsc_adr);
    matrix_mul_INST.B_rsc_d(TLS_B_rsc_d);
    matrix_mul_INST.B_rsc_we(TLS_B_rsc_we);
    matrix_mul_INST.B_rsc_q(TLS_B_rsc_q);
    ...
    A_rsc_INST.q(TLS_A_rsc_q);
    A_rsc_INST.we(TLS_A_rsc_we);
    A_rsc_INST.d(TLS_A_rsc_d);
    A_rsc_INST.adr(TLS_A_rsc_adr);
    A_rsc_INST.en(SIG_SC_LOGIC_1);
    A_rsc_INST.clk(clk);
    A_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_1)));

    B_rsc_INST.q(TLS_B_rsc_q);
    B_rsc_INST.we(TLS_B_rsc_we);
    B_rsc_INST.d(TLS_B_rsc_d);
    B_rsc_INST.adr(TLS_B_rsc_adr);
    B_rsc_INST.en(SIG_SC_LOGIC_1);
    B_rsc_INST.clk(clk);
    ...
    transactor_A.register_block(&A_rsc_INST, A_rsc_INST.basename(), TLS_A_rsc_triosy_lz, 0, 1023, 1);
    ...
    transactor_B.register_block(&B_rsc_INST, B_rsc_INST.basename(), TLS_B_rsc_triosy_lz, 0, 1023, 1);
