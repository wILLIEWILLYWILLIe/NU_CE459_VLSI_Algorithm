...
directive set /matrix_mul/core/core:rlp/main/for/for:for CSTEPS_FROM {{. == 4} {.. == 0}}
...
directive set /matrix_mul/core/core:rlp/main/for/for:for/for:for:for:mul CSTEPS_FROM {{.. == 2}}
directive set /matrix_mul/core/core:rlp/main/for/for:for/for:for:for:acc#7 CSTEPS_FROM {{.. == 3}}
directive set /matrix_mul/core/core:rlp/main/for/for:for/for:for:for:acc#3 CSTEPS_FROM {{.. == 3}}
directive set /matrix_mul/core/core:rlp/main/for/for:for/for:for:for:acc#4 CSTEPS_FROM {{.. == 1}}
directive set /matrix_mul/core/core:rlp/main/for/for:for/for:for:write_mem(C:rsc.@) CSTEPS_FROM {{.. == 3}}
directive set /matrix_mul/core/core:rlp/main/for/for:for/for:for:acc#2 CSTEPS_FROM {{.. == 1}}
directive set /matrix_mul/core/core:rlp/main/for/for:for/for:for:for:for:for:for:and CSTEPS_FROM {{.. == 3}}
directive set /matrix_mul/core/core:rlp/main/for/for:for/for:for:for:mux#5 CSTEPS_FROM {{.. == 3}}
