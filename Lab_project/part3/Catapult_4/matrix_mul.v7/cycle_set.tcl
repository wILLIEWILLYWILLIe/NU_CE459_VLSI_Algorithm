...
directive set /matrix_mul/core/core:rlp/main/for:for:for:acc#7 CSTEPS_FROM {{.. == 2}}
directive set /matrix_mul/core/core:rlp/main/for:for:for:acc#3 CSTEPS_FROM {{.. == 2}}
