...
#define ccs_intercept_mult_add_pipeline_5 \
  ccs_real_mult_add_pipeline(ac_channel<ac_int<11, false > > &a,ac_channel<ac_int<14, false > > &b,ac_channel<ac_int<25, false > > &c,ac_fixed<10, 2, true, AC_TRN, AC_WRAP > gain,bool gain_adjust,ac_channel<ac_int<30, false > > &result);\
...
#else
#define ccs_intercept_mult_add_pipeline_5 mult_add_pipeline
...
// iv 1340 INLINE
#define ccs_intercept_iv_1340 iv
// iv 1358 INLINE
...
// const 1418 INLINE
#define ccs_intercept_const_1418 const
// iv 1325 INLINE
#define ccs_intercept_iv_1325 iv
// const 1414 INLINE
#define ccs_intercept_const_1414 const
// iv 1333 INLINE
...
// iv_shift_r 1032 INLINE
#define ccs_intercept_iv_shift_r_1032 iv_shift_r
// value 2969 INLINE
