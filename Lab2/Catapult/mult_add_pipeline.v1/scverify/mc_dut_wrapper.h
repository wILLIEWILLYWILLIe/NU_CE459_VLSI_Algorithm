...
typedef
    ccs_design::HDL::mult_add_pipeline ccs_DUT_wrapper;
...
public:
  ...
  sc_in<bool> clk;
  sc_in<sc_logic> rst;
  sc_in<sc_lv<11> > a_rsc_dat;
  sc_in<sc_logic> a_rsc_vld;
  sc_out<sc_logic> a_rsc_rdy;
  sc_in<sc_lv<14> > b_rsc_dat;
  sc_in<sc_logic> b_rsc_vld;
  sc_out<sc_logic> b_rsc_rdy;
  sc_in<sc_lv<25> > c_rsc_dat;
  sc_in<sc_logic> c_rsc_vld;
  sc_out<sc_logic> c_rsc_rdy;
  sc_in<sc_lv<10> > gain_rsc_dat;
  sc_out<sc_logic> gain_rsc_triosy_lz;
  sc_in<sc_logic> gain_adjust_rsc_dat;
  sc_out<sc_logic> gain_adjust_rsc_triosy_lz;
  sc_out<sc_lv<30> > result_rsc_dat;
