...
public:
  ...
  sc_signal<sc_lv<7> >                                                    TLS_coeffs_rsc_adr;
  sc_signal<sc_lv<7> >                                                    TLS_coeffs_rsc_d;
  sc_signal<sc_logic>                                                     TLS_coeffs_rsc_we;
  sc_signal<sc_lv<7> >                                                    TLS_coeffs_rsc_q;
  ...
  ccs_ram_sync_singleport_trans_rsc<7,7,128 >                             coeffs_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 7, 7, 0)
    , catapult_monitor_INST("Monitor", clk, true, 7LL, 4LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(184, SC_NS);
    } else {
