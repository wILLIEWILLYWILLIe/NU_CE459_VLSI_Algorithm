...
public:
  ...
  sc_out<sc_lv<5> > coeffs_rsc_adr;
  sc_out<sc_lv<28> > coeffs_rsc_d;
  sc_out<sc_logic> coeffs_rsc_we;
  sc_in<sc_lv<28> > coeffs_rsc_q;
...
public:
  ...
  :
    ...
    coeffs_rsc_adr("coeffs_rsc_adr"), 
    coeffs_rsc_d("coeffs_rsc_d"), 
    coeffs_rsc_we("coeffs_rsc_we"), 
