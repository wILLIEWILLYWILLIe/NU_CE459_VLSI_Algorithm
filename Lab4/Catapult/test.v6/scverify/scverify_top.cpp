...
public:
  ...
  sc_signal<sc_lv<5> >                                                    TLS_coeffs_rsc_adr;
  sc_signal<sc_lv<28> >                                                   TLS_coeffs_rsc_d;
  sc_signal<sc_logic>                                                     TLS_coeffs_rsc_we;
  sc_signal<sc_lv<28> >                                                   TLS_coeffs_rsc_q;
  ...
  ccs_ram_sync_singleport_trans_rsc<28,5,32 >                             coeffs_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_coeffs_rsc_adr("TLS_coeffs_rsc_adr")
    , TLS_coeffs_rsc_d("TLS_coeffs_rsc_d")
    , TLS_coeffs_rsc_we("TLS_coeffs_rsc_we")
    , TLS_coeffs_rsc_q("TLS_coeffs_rsc_q")
    ...
    , transactor_coeffs("transactor_coeffs", 0, 28, 0)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    test_INST.coeffs_rsc_adr(TLS_coeffs_rsc_adr);
    test_INST.coeffs_rsc_d(TLS_coeffs_rsc_d);
    test_INST.coeffs_rsc_we(TLS_coeffs_rsc_we);
    test_INST.coeffs_rsc_q(TLS_coeffs_rsc_q);
    test_INST.coeffs_rsc_triosy_lz(TLS_coeffs_rsc_triosy_lz);
    ...
    coeffs_rsc_INST.q(TLS_coeffs_rsc_q);
    coeffs_rsc_INST.we(TLS_coeffs_rsc_we);
    coeffs_rsc_INST.d(TLS_coeffs_rsc_d);
    coeffs_rsc_INST.adr(TLS_coeffs_rsc_adr);
    coeffs_rsc_INST.en(SIG_SC_LOGIC_1);
    coeffs_rsc_INST.clk(clk);
    coeffs_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_2)));
