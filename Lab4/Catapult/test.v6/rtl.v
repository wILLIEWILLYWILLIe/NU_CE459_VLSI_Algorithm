...
//  Generated date: Thu Nov  6 19:36:21 2025
// ----------------------------------------------------------------------
...
module test_ccs_sample_mem_ccs_ram_sync_singleport_rwport_2_28_5_32_32_28_5_gen (
...
module test_core_coeffs_rsci_1_coeffs_rsc_wait_dp (
  ...
  input clk;
  input rst;
  input [27:0] coeffs_rsci_q_d;
  output [27:0] coeffs_rsci_q_d_mxwt;
  ...
  reg [27:0] coeffs_rsci_q_d_bfwt;


  // Interconnect Declarations for Component Instantiations 
  assign coeffs_rsci_q_d_mxwt = MUX_v_28_2_2(coeffs_rsci_q_d, coeffs_rsci_q_d_bfwt,
      coeffs_rsci_bcwt);
  always @(posedge clk) begin
    if ( rst ) begin
  ...
  always @(posedge clk) begin
    if ( rst ) begin
      coeffs_rsci_q_d_bfwt <= 28'b0000000000000000000000000000;
    end
...
module test_core (
  ...
  wire [27:0] coeffs_rsci_q_d_mxwt;
  ...
  reg [9:0] MAC_asn_1_itm_1;
  reg [9:0] MAC_asn_2_itm_1;
  wire MAC_asn_2_itm_1_mx0c1;
  ...
  assign MAC_asn_2_itm_1_mx0c1 = (~ reg_coeffs_rsc_triosy_obj_ld_core_psct_cse) &
      (fsm_output[1]);
  assign coeffs_rsci_adr_d = coeff_addr_rsci_idat_mxwt;
  ...
  always @(posedge clk) begin
    if ( rst ) begin
      ...
      MAC_asn_1_itm_1 <= 10'b0000000000;
  ...
  always @(posedge clk) begin
    ...
    else if ( core_wen & reg_coeffs_rsc_triosy_obj_ld_core_psct_cse ) begin
  ...
  always @(posedge clk) begin
    if ( rst ) begin
      MAC_asn_2_itm_1 <= 10'b0000000000;
    end
    else if ( core_wen & (reg_coeffs_rsc_triosy_obj_ld_core_psct_cse | MAC_asn_2_itm_1_mx0c1)
        ) begin
      MAC_asn_2_itm_1 <= MUX_v_10_2_2(10'b0000000000, SHIFT_if_asn_ncse_sva_1, (MAC_not_nl));
    end
  end
  assign MAC_3_mul_nl = conv_s2u_17_17($signed(MAC_asn_itm_1) * $signed((coeffs_rsci_q_d_mxwt[20:14])));
  assign MAC_4_mul_nl = conv_s2u_17_17($signed(MAC_asn_1_itm_1) * $signed((coeffs_rsci_q_d_mxwt[27:21])));
  assign MAC_1_mul_nl = conv_s2u_17_17($signed(SHIFT_if_asn_ncse_sva_1) * $signed((coeffs_rsci_q_d_mxwt[6:0])));
  assign MAC_2_mul_nl = conv_s2u_17_17($signed(MAC_asn_2_itm_1) * $signed((coeffs_rsci_q_d_mxwt[13:7])));
  ...
  assign MAC_not_nl = ~ MAC_asn_2_itm_1_mx0c1;
...
module test (
  ...
  input data_in_rsc_vld;
  output data_in_rsc_rdy;
  output [4:0] coeffs_rsc_adr;
  output [27:0] coeffs_rsc_d;
  output coeffs_rsc_we;
  input [27:0] coeffs_rsc_q;
  output coeffs_rsc_triosy_lz;
  input [4:0] coeff_addr_rsc_dat;
  input coeff_addr_rsc_vld;
  output coeff_addr_rsc_rdy;
  ...
  // Interconnect Declarations
  wire [4:0] coeffs_rsci_adr_d;
  wire [27:0] coeffs_rsci_q_d;
  wire coeffs_rsci_port_0_rw_ram_ir_internal_RMASK_B_d;


  // Interconnect Declarations for Component Instantiations 
  test_ccs_sample_mem_ccs_ram_sync_singleport_rwport_2_28_5_32_32_28_5_gen coeffs_rsci
      (
      .q(coeffs_rsc_q),
      .we(coeffs_rsc_we),
      .d(coeffs_rsc_d),
      ...
      .d_d(28'b0000000000000000000000000000),
      .we_d(1'b0),
      .q_d(coeffs_rsci_q_d),
